...
class IntroductionToMyMasjid extends StatefulWidget {
  final HiveMasjid? masjid;

  const IntroductionToMyMasjid({Key? key, this.masjid}) : super(key: key);

  @override
  State<IntroductionToMyMasjid> createState() =>
      _IntroductionToMyMasjidState();
}

class _IntroductionToMyMasjidState extends State<IntroductionToMyMasjid> {
