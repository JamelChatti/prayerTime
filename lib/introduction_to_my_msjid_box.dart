...
class IntroductionToMyMasjidBox extends StatefulWidget {
  final HiveMasjid? masjid;

  const IntroductionToMyMasjidBox({Key? key, this.masjid}) : super(key: key);

  @override
  State<IntroductionToMyMasjidBox> createState() =>
      _IntroductionToMyMasjidBoxState();
}

class _IntroductionToMyMasjidBoxState extends State<IntroductionToMyMasjidBox> {
